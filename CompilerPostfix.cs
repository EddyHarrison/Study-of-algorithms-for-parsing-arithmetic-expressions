...
public static class CompilerPostfix
{
    ...
    private static string[] SplitExpression(string sourceExpression)
    {
        ...
        while (position < expression.Length)
        {
            ...
            {
                if (expression.Substring(position, arrayOperation[indexOperation].Length).StartsWith(arrayOperation[indexOperation]))
                {
                    ...
                    result.Add(expression.Substring(position, arrayOperation[indexOperation].Length));
